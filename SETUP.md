...
- Link = The link to your files EG: [https://Carnage.s3.us-east-2.amazonaws.com/repo/] MAKE SURE TO APPEND THE REPO ON TH END
...
* First copy the release plugin from my repo to your project here are the places to note
    - https://github.com/Mark7625/Carnage-Client-Public/tree/master/buildSrc <- Copy this whole dir
    - https://github.com/Mark7625/Carnage-Client-Public/blob/master/build.gradle.kts
...
1) Go into launcher.properties And edit 'Carnage' and links to your server links and name
...
runelite.download.link=https://**Carnage**.net/download/  
runelite.website=https://**Carnage**.net/  
runelite.bootstrap=https://Carnage.s3.eu-west-2.amazonaws.com/bootstrap.json  
runelite.bootstrapsig=https://Carnage.s3.eu-west-2.amazonaws.com/bootstrap.json.sha256  
runelite.name=**Carnage**  
...
Make sure CC is selected and replace 'Carnage' with 'MyCoolName' MAKE SURE ITS CAPS E same with the server name

3) Inside Intellij click the root of the project and press CTRL + ALT + R

Make sure CC is selected and replace 'Carnage' with 'myCoolName' MAKE SURE ITS LOWERCASE E same with the server name
...
Once you have pushed your files to github, github actions will build your launcher you can then find them under the workflow action it runs EG: https://github.com/Carnage-Community/Runelite-Launcher-rsps/actions/runs/3014844052
