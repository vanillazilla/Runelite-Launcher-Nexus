...
public class ColorScheme
{
	...
	public static final Color BRAND = new Color(236, 105, 11);

	/* The blue color used for the branding's accents, with lowered opacity */
	public static final Color BRAND_TRANSPARENT = new Color(251, 92, 2, 120);
	...
	public static final Color PROGRESS_ERROR_COLOR = new Color(251, 92, 2, 120);
}